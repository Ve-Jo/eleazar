...
app.post(
  ...
  async (req, res) => {
    try {
      ...
      // Use our database client to update the balance
      const Database = await import("../../database/client.js");
      const result = await Database.default.addBalance(guildId, userId, amount);
