const Leaderboard = (props) => {
  ...
  const translations = Object.entries(Leaderboard.localization_strings).reduce(
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <span style={{ display: "flex" }}>{translations.currentPage}:</span>
          <div
            style={{
              fontWeight: "bold",
        ...
        >
          <span style={{ display: "flex" }}>{translations.sortBy}:</span>
          <div
            style={{
              fontWeight: "bold",
              backgroundColor: "orange",
